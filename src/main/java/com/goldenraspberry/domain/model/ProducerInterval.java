...
/**
 * ProducerInterval value object
 * Representa o intervalo entre vitorias consecutivas de um Producer
 */
    ...
    private void validateInterval() {
        ...
        if (interval != calculatedInterval) {
            throw new IllegalArgumentException(
                String.format("Interval informado (%d) nao confere com calculo (%d)",
