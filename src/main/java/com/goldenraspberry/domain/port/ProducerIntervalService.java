...
/**
 * Interface de servico para operacoes de intervalo de Producer Este e um port na arquitetura
 * hexagonal
 */
public interface ProducerIntervalService {

  /**
   * Obtem intervalos minimo e maximo entre vitorias consecutivas Retorna todos os empates para cada
   * categoria (min/max)
   *
  ...
  /**
   * Atualiza calculos de intervalo Este metodo deve ser chamado quando os dados de Movie mudarem
   */
